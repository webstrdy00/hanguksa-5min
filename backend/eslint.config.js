...
export default tseslint.config(
  ...
  },
  {
    ...
    files: [
      ...
      'src/admin/build-review-sheet.ts',
      'src/admin/normalize-questions.ts',
      'src/admin/apply-choice-fix.ts',
      'src/admin/apply-distractor-fix.ts',
      'src/admin/apply-explanation-fix.ts',
      'src/admin/fact-check.ts',
      '**/*.test.ts',
    ],
